...
namespace NKGGameFramework.Diagnostics
{
    ...
    public static class GameDebugDumpAnalyzer
    {
        ...
        {
            NkgThrow.IfNull(report);
            return JsonConvert.SerializeObject(report, GameDebugJson.Options);
        }
        ...
        private sealed class Accumulator
        {
            ...
            public Accumulator(string key, string? displayName)
            {
                _key = key;
