...
namespace NKGGameFramework.Nodes
{
    ...
    public sealed class NodeGraphUndoRedo
    {
        ...
        private readonly Stack<INodeGraphCommand> _undo = new();
        private readonly Stack<INodeGraphCommand> _redo = new();
    ...
    public sealed class DeleteNodeCommand : INodeGraphCommand
    {
        ...
        private readonly List<NodePortLine> _lines = new();
        private Node _node = null!;
