...
namespace NKGGameFramework.Gameplay
{
    ...
    public sealed class BuffUpdateSystem : EcsSystem
    {
        ...
        private readonly List<BehaviorTreeInstance> _behaviorTreesToStart = new();
        private readonly List<BehaviorTreeInstance> _behaviorTreesToUpdate = new();
        private readonly List<BehaviorTreeInstance> _behaviorTreesToCancel = new();
