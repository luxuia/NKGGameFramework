...
namespace NKGGameFramework.Gameplay
{
    ...
    public sealed class BuffDefinition
    {
        ...
        public Dictionary<string, double> Scalars { get; init; } = new();

        public List<string> EventKeys { get; init; } = new();

        public BehaviorTreeDefinition? ExecutionTree { get; init; }
        public List<AttributeModifierSpec> AttributeModifiers { get; init; } = new();
