...
namespace NKGGameFramework.Gameplay
{
    ...
    public sealed class GameplayTagContainer : IReadOnlyCollection<GameplayTag>, IEquatable<GameplayTagContainer>
    {
        ...
        [OdinSerialize]
        private readonly HashSet<GameplayTag> _parentTags = new();
        ...
        {
            NkgThrow.IfNull(otherA);
            NkgThrow.IfNull(otherB);
        ...
        {
            NkgThrow.IfNull(containerToCheck);
        ...
        public override int GetHashCode()
        {
            ...
            foreach (var tag in _tags.OrderBy(tag => tag))
            {
                hash.Add(tag);
            }
