...
namespace NKGGameFramework.Gameplay
{
    ...
    public readonly struct GameplayTagTableParseResult : IEquatable<GameplayTagTableParseResult>
    {
        public readonly int RowsRegistered;

        public GameplayTagTableParseResult(int RowsRegistered)
        {
            this.RowsRegistered = RowsRegistered;
        }

        public bool Equals(GameplayTagTableParseResult other) => EqualityComparer<int>.Default.Equals(RowsRegistered, other.RowsRegistered);

        public override int GetHashCode() => HashCode.Combine(RowsRegistered);

        public override bool Equals(object? obj) => obj is GameplayTagTableParseResult other && Equals(other);

        public static bool operator ==(GameplayTagTableParseResult left, GameplayTagTableParseResult right) => left.Equals(right);
        public static bool operator !=(GameplayTagTableParseResult left, GameplayTagTableParseResult right) => !left.Equals(right);

        public void Deconstruct(out int rowsRegistered)
        {
            rowsRegistered = RowsRegistered;
        }
    }
    ...
    public static class GameplayTagTableParser
    {
        ...
        {
            foreach (var rawLine in csvText.Split(new[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries))
            {
