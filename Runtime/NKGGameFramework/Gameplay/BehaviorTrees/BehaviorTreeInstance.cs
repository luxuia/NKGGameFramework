...
namespace NKGGameFramework.Gameplay
{
    ...
    {
        private readonly Queue<Action> _executionRequests = new();
        private readonly List<BehaviorTimer> _timers = new();
        private readonly HashSet<IBehaviorUpdatable> _updatables = new();
        private readonly List<Action> _timerCallbacks = new();
        private readonly List<IBehaviorUpdatable> _updatablesToUpdate = new();
