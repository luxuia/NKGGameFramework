...
namespace NKGGameFramework.Gameplay
{
    ...
    public sealed class SkillDefinition
    {
        ...
        public List<string> ResourceLocations { get; init; } = new();
        ...
        public Dictionary<int, TimeSpan> Cooldowns { get; init; } = new();

        public Dictionary<int, double> Costs { get; init; } = new();

        public List<SkillEffectDefinition> Effects { get; init; } = new();
