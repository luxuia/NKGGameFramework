...
namespace NKGGameFramework.Ecs
{
    ...
    public sealed class Scene : IDisposable
    {
        ...
        private readonly Dictionary<Type, ISceneComponent> _sceneComponents = new();
